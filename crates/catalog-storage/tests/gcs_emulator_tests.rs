...
mod tests {
    ...
    #[test]
    fn test_gcs_initialize_catalog() {
    ...
    #[test]
    fn test_gcs_upload_download_roundtrip() {
    ...
    #[test]
    fn test_gcs_not_found_handling() {
    ...
    #[test]
    fn test_gcs_concurrent_write_detection() {
    ...
    #[test]
    fn test_gcs_metadata_preservation() {
